...
class RejectionAttestationProcessor implements ProcessorInterface
{    
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = [])
    {
        ...
        $this->attestationGage->apply($attestation, 'reject');
        $attestationRejection= $supervisorService->reject($attestation, $data->rejectionCause);
        
        $this->em->persist($attestationRejection);
        $this->em->flush();
